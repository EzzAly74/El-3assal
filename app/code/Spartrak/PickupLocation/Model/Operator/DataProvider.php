...
namespace Spartrak\PickupLocation\Model\Operator;
...
class DataProvider extends AbstractDataProvider
{
    ...
    public function getData(): array
    {
        ...
        $stashed = $this->dataPersistor->get('spartrak_pickup_operator');

        if (!empty($stashed)) {
            $entityId = (int) ($stashed['operator_id'] ?? 0);
            $this->loadedData[$entityId] = $stashed;
            $this->dataPersistor->clear('spartrak_pickup_operator');
        }
