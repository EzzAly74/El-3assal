...
namespace Spartrak\PickupLocation\Model\Depot;

use Magento\Framework\App\Request\DataPersistorInterface;
use Magento\Ui\DataProvider\AbstractDataProvider;
use Spartrak\PickupLocation\Model\ResourceModel\Depot\CollectionFactory;

/**
 * Feeds the depot edit form.
 *
...
class DataProvider extends AbstractDataProvider
{
    ...
    public function getData(): array
    {
        ...
        $stashed = $this->dataPersistor->get('spartrak_pickup_depot');

        if (!empty($stashed)) {
            $entityId = (int) ($stashed['depot_id'] ?? 0);
            $this->loadedData[$entityId] = $stashed;
            $this->dataPersistor->clear('spartrak_pickup_depot');
        }
